{
  ...
  # pinned ollama source (flake input)
  src,
  version ? "0.32.7",
  vendorHash ? "sha256-HMwoaFBMbpoy8f0I+O+i7kIa9BslLu3FcVWeaIOkpvs=",
  llamaCppHash ? "sha256-mBqO6h9eiSAXqiHy1H3aK2ACbz1aYagmjAN7IpXNTcw=",
}:
...
let
  ...
  llamaCppVersion = lib.trim (builtins.readFile (src + "/LLAMA_CPP_VERSION"));
