...
in
{
  bind =
    [
      ...
      (mkBind "space" (exec "quickshell ipc call launcher toggle apps"))
      (mkBind "escape" (exec "quickshell ipc call launcher toggle powermenu"))
      (mkBind "SHIFT + SPACE" (exec "quickshell ipc call bar toggle"))
      (mkBind "SHIFT + W" (exec "ghostty --class=ghostty.walt -e walt"))
      (mkBind "I" (exec "quickshell ipc call popups toggle wifi"))
      (mkBind "SHIFT + B" (exec "quickshell ipc call popups toggle bluetooth"))
      ...
      (mkBind "CTRL + K" (exec "quickshell ipc call launcher toggle keybinds"))
      (mkBind "SHIFT + R" (exec "quickshell ipc call launcher toggle rebuild"))
